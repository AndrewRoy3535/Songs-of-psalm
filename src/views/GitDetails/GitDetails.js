...
const GitDetails = ({route, navigation}) => {
  const {item} = route.params;
  const context = useContext(Contextprovider);
  const {gitSonghita, goToNextBook, goToPreviousBook} = context;
  ...
  return (
    <>
      ...
      <Animated.View
        ...
        <FAB
          goToNextBook={() =>
            goToNextBook(gitSonghita, item, 'GitDetails', navigation)
          }
          goToPreviousBook={() =>
            goToPreviousBook(gitSonghita, item, 'GitDetails', navigation)
          }
        />
      </Animated.View>
    </>
